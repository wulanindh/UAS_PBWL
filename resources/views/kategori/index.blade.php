...
<html lang="en">
  ...
  <div class="container" style="margin-top: 80px">
    ...
    <div class="row">
      <div class="col">
         <a href="{{ url('kategori/create') }}" class="btn btn-md btn-success">Add Kategori</a>
      </div>
    </div>
...
<table class="table table-hover"id="myTable">
  ...
  <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0">
          ...
          <a href="{{ url('kategori/edit/' . $row->kat_id) }}"><button class ="btn btn-warning btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
