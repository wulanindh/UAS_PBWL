...
<table class="table table-bordered"  >
    ...
    <tr>
        ...
        <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item" value="{{ $item->menu }}">{{ $item->menu }}</li>
                    @endforeach
              </ul>
           </td>
  ...
  <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0">
          ...
          <a href="{{ url('bayar/edit/' . $row->menu_id) }}"><button class ="btn btn-warning btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
